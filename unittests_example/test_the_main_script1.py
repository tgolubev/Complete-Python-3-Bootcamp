...
import unittest
import main_script1      #import all the files which want to test (don't need the .py extension)
...
# unittest called TestCase
    ...
    def test_one_word(self):
        ...
        result =  main_script1.cap_text(text) #use the cap_text function from main_script module
    ...
    def test_multiple_words(self):
        text = 'monty python'
        result = main_script1.cap_text(text)
